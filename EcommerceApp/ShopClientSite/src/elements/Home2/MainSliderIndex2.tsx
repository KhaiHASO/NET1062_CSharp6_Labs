        ...
        <div className="main-slider style-2"> 
			<div className="main-swiper2">
							...
							<div className="col-xl-7 col-lg-7 col-md-12 align-self-center">
								<div className="swiper-content">
									...
									<div className="content-btn" data-swiper-parallax="-60">
										<Link className="btn btn-secondary me-3" to="/shop-cart">ADD TO CART</Link>
										<Link className="btn btn-outline-secondary" to="/shop-standard">VIEW DETAILS</Link>
									</div>
								</div>
                            </div>
							<div className="col-xl-5 col-lg-5 col-md-12">
								<div className="banner-media">
									...
									<div className="img-preview" data-swiper-parallax="-100">
										<img src={IMAGES.MainSliider2} alt="banner-media" />
									</div>
									<div className="bnr-content-bx slideskew">
										<div className="dz-media">
											<img src={IMAGES.ProductSmall1} alt="shirt" />
										</div>
										...
										<ul>
                                            {CustomerImage.map((elem, i)=>(
                                                <li className="customer-image" key={(i)}>
                                                    <img src={elem.image} alt="testimonial" />
                                                </li>
                                            ))}											
										</ul>
									</div>
				...
				<div className="banner-social-media style-2 left">
					<ul>
						<li>
							<Link to="https://www.instagram.com/dexignzone/" target="_blank">Instagram</Link>
						</li>
						<li>
							<Link to="https://www.facebook.com/dexignzone" target="_blank">Facebook</Link>
						</li>
						<li>
							<Link to="https://twitter.com/dexignzones" target="_blank">twitter</Link>
						</li>
					</ul>
				</div>
				<Link to="/contact-us-2" className="service-btn btn-dark">Let’s talk</Link>
			</div>
		</div>	
    )
}