        ...
        <div className="row about-style1">
            <div className="col-lg-6 col-md-12 m-b30">
                <div className="about-thumb wow fadeInUp  position-relative" data-wow-delay="0.2s">
                    ...
                    <Link to="/shop-list" className="btn btn-outline-secondary btn-light btn-xl">Woman collection</Link>	
                </div>
            </div>
                        ...
                        <div className="col-lg-6 col-md-6 col-sm-6">
                            <div className="shop-card style-6 wow fadeInUp" data-wow-delay="0.8s">
                                ...
                                <div className="dz-content">
                                    <Link to="/shop-list" className="btn btn-outline-secondary btn-light btn-md">Child Fashion</Link>
                                </div>
                            </div>
                        </div>
                        <div className="col-lg-6 col-md-6 col-sm-6">
                            <div className="shop-card style-6 wow fadeInUp" data-wow-delay="1.0s">
                                ...
                                <div className="dz-content">
                                    <Link to="/shop-list" className="btn btn-outline-secondary btn-light btn-md">Man collection</Link>
                                </div>
