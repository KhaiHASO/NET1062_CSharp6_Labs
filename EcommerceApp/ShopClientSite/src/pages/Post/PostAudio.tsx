                        ...
                        <div className="col-xl-8 col-lg-8">
                            <div className="dz-blog blog-single style-1 sidebar"> 
                                ...
                                <div className="dz-media post-audio ">
                                    <iframe className="rounded" src="https://w.soundcloud.com/player/?visual=true&#038;url=https://soundcloud.com/secret-service-862007284/old-town-road&#038;show_artwork=true&#038;maxwidth=750&#038;maxheight=1000&#038;dnt=1"></iframe>
                                </div>
