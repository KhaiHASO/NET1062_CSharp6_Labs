...
const AboutMe = () => {
    return (
        <div className="page-content bg-light">
           <CommanBanner mainText = "About Me" parentText="Home" currentText="Shop Standard" image={IMAGES.BackBg1}/>
            ...
            <section className=" about-style4">
                                ...
                                <div className="our-customer wow fadeInUp" data-wow-delay="0.2s" style={{visibility: "visible", animationDelay: "0.2s", animationName: "fadeInUp"}}>
                                    ...
                                    <ul>
                                        <li className="customer-image">
                                            <img src={IMAGES.testimoniaPic1} alt="" />
                                        </li>
                                        <li className="customer-image">
                                            <img src={IMAGES.testimoniaPic2} alt="" />
                                        </li>
                ...
                <img src={IMAGES.LineShape} alt="" className="line" /> 
            </section>
