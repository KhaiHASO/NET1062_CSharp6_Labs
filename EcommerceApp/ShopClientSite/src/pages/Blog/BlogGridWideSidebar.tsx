...
export default function BlogGridWideSidebar(){
    return(
        <div className="page-content bg-light">
            <CommanBanner parentText="Home" currentText="Blog Grid Wide" mainText="Blog Grid Wide" image={IMAGES.BackBg1} />
                        ...
                        <div className="col-xl-12">
                            <div className="row">
                                        ...
                                        <div className="dz-card style-5">
                                            ...
                                            <div className="dz-info">
                                                ...
                                                <h4 className="dz-title">
                                                    <Link className="text-white" to="/blog-dark-2-column">{data.text}</Link>
                                                </h4>
                                                <Link to="/blog-dark-2-column" className="font-14 read-btn">Read More 
                                ...
                                <div className="col-12 text-center mt-sm-4 mb-sm-4  wow fadeInUp" data-wow-delay="1.0s">
                                    <Link to="/blog-grid-wide-sidebar" className="btn btn-secondary text-center">Load More</Link>
                                </div>
                            </div>
                        </div>
                    </div>
