...
export default function BlogLight2Sidebar(){
    return(
        <div className="page-content bg-light">
            <CommanBanner parentText="Home" currentText="Blog Light 2 Column Sidebar" mainText="Blog Light 2 Column Sidebar" image={IMAGES.BackBg1} />
                        ...
                        <div className="col-xl-8 col-lg-8">
                            <div className="row">
                                        ...
                                        <div className="dz-card style-5 light">                                            
                                            ...
                                            <div className="dz-info">
                                                ...
                                                <h4 className="dz-title">
                                                    <Link  to="/post-left-sidebar">{elem.text}</Link>
                                                </h4>
                                                <Link to="/post-standard" className="font-14 read-btn">Read More 
                                ...
                                <div className="col-12 text-center mt-sm-4 mt-2 wow fadeInUp" data-wow-delay="0.7s">
                                    <Link to="/blog-dark-2-column-sidebar" className="btn btn-secondary">
                                        Load More
                                    </Link>
                                </div>
                            </div>
