...
export default function BlogLight2Column(){
    return(
        <div className="page-content bg-light">
            <CommanBanner currentText="Blog Light 2 Column" mainText="Blog Light 2 Column" parentText="Home" image={IMAGES.BackBg1}/>
                ...
                <div className="container">
                    <div className="row">
                                ...
                                <div className="dz-card style-1 light">
                                    ...
                                    <div className="dz-info">
                                        ...
                                        <h3 className="dz-title">
                                            <Link to="/post-standard">{item.text}</Link>
                                        </h3>
                        ...
                        <div className="col-12 text-center mt-sm-4 mt-2 wow fadeInUp" data-wow-delay="0.5s">
                            <Link to="/blog-light-2-column" className="btn btn-secondary">
                                Load More
                            </Link>
                        </div>
                    </div>
