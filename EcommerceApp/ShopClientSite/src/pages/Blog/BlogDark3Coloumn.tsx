...
const BlogDark2 : BlogDark2Type[] = [
    {dealy : "0.1s", image: IMAGES.BlogGrid1, date:'25 Jan, 2025', text:"Trendsetter Chronicles: Unveiling the Latest in Fashion"},
    {dealy : "0.2s", image: IMAGES.BlogGrid2, date:'30 Jan, 2025', text:"Runway Rundown: Decoding Fashion Week’s Best Looks"},
    {dealy : "0.3s", image: IMAGES.BlogGrid3, date:'17 Jan, 2025', text:"Closet Confidential: Behind-the-Scenes of a Fashionista"},
    {dealy : "0.4s", image: IMAGES.BlogGrid4, date:'21 Jan, 2025', text:"DIY Couture: Crafting Your Own Fashion Masterpieces"},
    {dealy : "0.5s", image: IMAGES.BlogGrid5, date:'25 Jan, 2025', text:"Street Style Safari: Global Fashion Influences"},
    {dealy : "0.6s", image: IMAGES.BlogGrid1, date:'28 Jan, 2025', text:"Sustainable Style: Eco-Friendly Fashion Choices"},
]; 

export default function BlogDark3Coloumn(){
    return(
        <div className="page-content bg-light">
            <CommanBanner parentText="Home" currentText="Blog Dark 3 Column" mainText="Blog Dark 3 Column" image={IMAGES.BackBg1}/>
