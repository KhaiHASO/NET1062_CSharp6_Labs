                            ...
                            <div className="account-card order-details">
                                <div className="order-head">
                                    <div className="head-thumb">
                                        <img src={IMAGES.ShopSmallPic1} alt="small_pic1" />
                                    </div>
                                ...
                                <div className="content-btn m-b15">
                                    <Link to="/shop-wishlist" className="btn btn-secondary me-xl-3 me-2 m-b15 btnhover20">Export Details</Link>
                                    <Link to="/product-default" className="btn btn-outline-secondary m-b15 me-xl-3 me-2 btnhover20">Request Confirmation</Link>
                                        ...
                                        <Tab.Content className="tab-content" id="nav-tabContent">
                                            ...
                                            <Tab.Pane eventKey={"details"}> 
                                                ...
                                                <div className="tracking-item">
                                                    <div className="tracking-product"><img src={IMAGES.ShopSmallPic1} alt="smil" /></div>
