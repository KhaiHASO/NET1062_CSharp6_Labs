                       ...
                       <CommanSidebar />
                        <section className="col-xl-9 account-wrapper">
                            <div className="account-card">
                                <div className="m-b30">
                                    <p>Hello <strong className="text-black">John Doe</strong> (not <strong className="text-black">John Doe</strong>? <Link to="/" className="text-underline">Log out</Link>)</p>
                                                ...
                                                {countries.map((item, ind)=>(
                                                    <li key={ind} className={item.className}>
                                                        <div className="thumb-detail">
                                                            <img src={item.imgSrc} alt="country" />
