            ...
            {AboutAccordionData.map((item, ind)=>(
                <Accordion.Item eventKey={`${ind}`}>
                    <Accordion.Header   id="headingOne">
                        <Link to={"#"}>{item.headtext}<span className="toggle-close"></span></Link>
                    </Accordion.Header>
                    <Accordion.Body>                   
                ...
                <div className="row">
                    <Tab.Container defaultActiveKey={'General'}>
                        <div className="col-xl-6 col-lg-6 col-md-12 faq-side-content">
                            ...
                            <motion.div className="dz-media d-none d-lg-block d-xl-block rounded"
                                animate={{ y : 0}}
                                initial={{ y : '50%'}}
                                transition={{duration : 1.2}}
                            > 
                                <img className="media" src={IMAGES.FaqPic1} alt="" />
                            </motion.div>
                        </div>
                        
                        <div className="col-xl-6 col-lg-6 col-md-12 faq-end-content">
                            <motion.div className="faq-head"
                                animate={{ y : 0}}
                                initial={{ y : '50%'}}
