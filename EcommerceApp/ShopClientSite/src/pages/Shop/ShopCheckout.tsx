                            ...
                            <div className="order-detail sticky-top">
                                <div className="cart-item style-1">
                                    <div className="dz-media">
                                        <img src={IMAGES.ShopCardPic1} alt="/" />
                                    </div>
                                ...
                                <div className="cart-item style-1 mb-0">
                                    <div className="dz-media">
                                        <img src={IMAGES.ShopCardPic2} alt="/" />
                                    </div>
                                    <div className="dz-content">
                                    ...
                                    <div className="accordion-item">
                                        <div className="accordion-header" id="heading3">
                                            <div className="accordion-button collapsed custom-control custom-checkbox border-0" data-bs-toggle="collapse" data-bs-target="#collapse3" role="navigation" aria-expanded="true" aria-controls="collapse3">
                                                ...
                                                <img src={IMAGES.ShopPayment} alt="/" />
                                ...
                                <p className="text">Your personal data will be used to process your order, support your experience throughout this website, and for other purposes described in our <Link to="#">privacy policy.</Link></p>
                                <div className="form-group">
                                ...
                                <Link to="/shop-checkout" className="btn btn-secondary w-100">PLACE ORDER</Link>
                            </div>
                        </div>
                    </div>
                </div>
